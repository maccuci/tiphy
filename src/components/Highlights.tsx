            ...
            <ul className="grid grid-cols-1 gap-4">
                <HighlightsItem>
                    ...
                    <div>
                        ...
                        <p className="absolute text-xl max-sm:text-xs font-bold text-white top-[31rem] max-sm:top-[12.5rem] left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-80">Shortcut your 9 to 6.</p>
                        <button className="absolute boder border-none font-bold text-center rounded-xl bg-[#F7B700] py-[8px] px-[20px] text-lg max-sm:text-base top-[37rem] max-sm:top-[14.5rem] left-1/2 -translate-x-1/2 -translate-y-1/2">PRE-ORDER NOW</button>
                    </div>
                </HighlightsItem>
                <HighlightsItem>
                    <div className="container max-w-screen-lg mx-auto flex justify-center mt-2">
                        ...
                        <p className="absolute text-xl max-sm:text-xs font-bold text-white text-center top-[62rem] max-sm:top-[31rem] left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-80">New heights, new lights, and new highlights.</p>
                        <button className="absolute boder border-none font-bold text-center rounded-xl bg-[#01dfb0] py-[8px] px-[20px] text-lg max-sm:text-base top-[65rem] max-sm:top-[33.5rem] left-1/2 -translate-x-1/2 -translate-y-1/2">BUY NOW</button>
                    </div>
                </HighlightsItem>
            </ul>
        </div>
