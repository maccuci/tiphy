    ...
    return (
        <div>
            <ul className="grid grid-cols-1 gap-4">
                ...
                <HighlightsItem>
                    <div className="container max-w-screen-lg mx-auto flex justify-center mt-2">
                        <img src="https://i.shgcdn.com/6752b524-36f8-46c7-82c8-ad6dad174d79/-/format/auto/-/preview/3000x3000/-/quality/lighter/" className="border rounded-xl max-sm:w-[21rem] h-auto max-sm:h-[14.5rem] sm:aspect-video" alt="Thumbnail" />
